...
```
* 12\. manually edit to add markdown headings and number the domains to get an idea of the numbers 
* 13\. [result is a list of good and bad mozilla related domains for SUMO](https://github.com/rtanglao/rt-csp/blob/master/mozilla-good-bad-domains.md)
## 20March2017
